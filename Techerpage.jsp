...
<form action="" name="btn">
    <table width="300px" border="0px" cellspacing="7px" cellpadding="5" class="tabletheme" align="center">
      <tr align="center" ><td><img src="teacher.png" style="width: 100%; height: 180px" ></tr></td>
    <tr>
        <td>
    <%
 ...
 <tr><td>  <input type="password"  name="passvalue" placeholder="enter your password" class="fieldtheme"></td></tr>
    ...
    <tr align="center"><td><input type="submit" value="Login" color=" blue" class="btntheme" name="btn" onclick="check()">
    ...
    <div align="center" style="color:white"><font size="5px">don't have an account? Then SignUp</font></div>
                
                <form action="teachersignup.jsp" name="btn1" method="post">
    <table width="300px" border="0px" cellspacing="7px" cellpadding="5" class="tabletheme" align="center">
